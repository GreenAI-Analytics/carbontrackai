...
export default function AffectedCommunitiesPage() {
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">ESRS S3-1 to S3-5 • Track community engagement, indigenous rights, and economic impact assessments.</p>
      </div>
