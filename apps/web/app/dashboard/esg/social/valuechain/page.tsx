...
export default function WorkersValueChainPage() {
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">ESRS S2-1 to S2-5 • Map supply chain, conduct human rights due diligence, and track remediation.</p>
      </div>
