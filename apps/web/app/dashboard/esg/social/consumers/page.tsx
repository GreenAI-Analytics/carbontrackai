...
export default function ConsumersEndUsersPage() {
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">ESRS S4-1 to S4-5 • Monitor product safety incidents, health impacts, privacy, and accessibility.</p>
      </div>
