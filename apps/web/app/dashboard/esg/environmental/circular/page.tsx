...
export default function ResourceUseCircularEconomyPage() {
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">ESRS E5-1 to E5-7 • Track material flows, waste by type and disposal method, and calculate circularity rate.</p>
      </div>
